<script setup>
// Step-guide through the ecosystem tour — one stop per slide, most common first.
...
const steps = [
  ...
  { icon: 'shipping-container', label: 'Docker' },
...
<template>
  <StepGuide :steps="steps" :current="current" compact />
</template>
